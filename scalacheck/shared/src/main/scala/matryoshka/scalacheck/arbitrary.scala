...
trait ArbitraryInstances extends ArbitraryInstancesʹ {
  ...
  @Deviation("ApplicativeBuilder is deprecated, use mapN.")
  ...
  @Deviation("ApplicativeBuilder is deprecated, use mapN. Use List instead of IList.")
  implicit def nonEmptyListArbitrary: Delay[Arbitrary, NonEmptyList] =
    new Delay[Arbitrary, NonEmptyList] {
      def apply[A](arb: Arbitrary[A]) =
        Arbitrary((arb.arbitrary, Gen.listOf[A](arb.arbitrary)).mapN((h, t) =>
